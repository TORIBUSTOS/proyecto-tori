...
echo ================================================================================
echo 🐂 TORO Investment Manager - MODO DESARROLLO
echo ================================================================================
echo.
echo [!] Hot-reload ACTIVADO - Los cambios en código se recargan automáticamente
echo [!] Usar este modo SOLO para desarrollo y pruebas
echo.
...
REM Iniciar servidor en modo DESARROLLO (bloqueante)
python run_dev.py
