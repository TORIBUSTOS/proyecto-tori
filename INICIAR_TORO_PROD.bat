...
echo ================================================================================
echo 🐂 TORO Investment Manager - MODO PRODUCCIÓN
echo ================================================================================
echo.
echo [✓] Sistema estable - Sin hot-reload
echo [✓] Modo recomendado para uso diario
echo.
...
REM Iniciar servidor en modo PRODUCCIÓN (bloqueante)
python run_prod.py
